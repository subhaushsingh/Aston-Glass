export default function Hero() {
    return (
       <header id="home" className="relative bg-gray-900 text-white text-center py-40 px-6 min-h-screen flex items-center justify-center">  
        <div className="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=1920&auto=format&fit=crop')] bg-cover bg-center bg-fixed border-b border-white/10"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-gray-900/50 to-gray-900/90 z-0"></div>
