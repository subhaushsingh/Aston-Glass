          ...
          <div className="w-full md:w-5/12">
            ...
            <div className="space-y-6 text-gray-200">
              <div className="flex items-start">
                ...
                <span className="text-red-500 text-xl mr-4 mt-1">📍</span>
                <p><strong>Factory:</strong><br />Laxmi Estate, Survey No. 693, Plot No. 1A, Village: Khambha, Taluka: Lodhika, District: Rajkot - 365650 (Gujarat.) India.</p>
              </div>
              <div className="flex items-start">
                <span className="text-red-500 text-xl mr-4 mt-1">📞</span>
                <p><strong>Phone:</strong><br />
                  <a href="tel:+919512011163" className="text-pink-400 hover:text-red-500 transition-colors">+91 95120 11163</a>
                </p>
              </div>
              <div className="flex items-start">
                <span className="text-red-500 text-xl mr-4 mt-1">💬</span>
                <p><strong>WhatsApp:</strong><br />
                  <a href="https://wa.me/919512011163" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-red-500 transition-colors">+91 95120 11163</a>
                </p>
              </div>
              <div className="flex items-start">
